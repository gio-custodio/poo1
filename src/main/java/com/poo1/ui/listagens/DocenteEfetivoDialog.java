 ...
 */
public class DocenteEfetivoDialog extends javax.swing.JDialog {

    /**
     * Creates new form CadastroDepartamentoDialog
     */
    public DocenteEfetivoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DocenteEfetivoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DocenteEfetivoDialog dialog = new DocenteEfetivoDialog(new javax.swing.JFrame(), true);
