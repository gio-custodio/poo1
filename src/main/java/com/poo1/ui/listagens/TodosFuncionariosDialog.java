 ...
 */
public class TodosFuncionariosDialog extends javax.swing.JDialog {

    /**
     * Creates new form CadastroDepartamentoDialog
     */
    public TodosFuncionariosDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TodosFuncionariosDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TodosFuncionariosDialog dialog = new TodosFuncionariosDialog(new javax.swing.JFrame(), true);
